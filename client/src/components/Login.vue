...
<script type="text/javascript">
  export default {
    ...
    created: () => {
      if(localStorage.getItem('username') && localStorage.getItem('loggedIn')) {
    ...
    methods: {
      login() {
        ...
        this.$http.post(url, params, {credentials: true, headers: {'Content-Type': 'application/x-www-form-urlencoded'}})
          .then(res => {
            this.loggedIn=true;
